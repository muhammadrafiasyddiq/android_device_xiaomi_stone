...
VENDOR_PLATFORM_LINKS := \
	...
	$(TARGET_OUT_VENDOR)/lib64/ov8856_aac_front_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/ov8856_ofilm_front_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/ov8856_ofilm_front_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/s5kjn1_ofilm_main_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5kjn1_ofilm_main_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5kjn1_ofilm_main_mipi_raw_india_p_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5kjn1_ofilm_main_mipi_raw_india_p_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/s5kjn1_ofilm_main_mipi_raw_india_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/s5kjn1_ofilm_main_mipi_raw_tuning.so \
	$(TARGET_OUT_VENDOR)/lib64/s5kjn1_sunny_main_mipi_raw_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5kjn1_sunny_main_mipi_raw_india_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5kjn1_sunny_main_mipi_raw_india_p_IdxMgr.so \
	$(TARGET_OUT_VENDOR)/lib64/s5kjn1_sunny_main_mipi_raw_india_p_tuning.so \
